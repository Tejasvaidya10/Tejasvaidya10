...
| [**SparkPath**](https://github.com/Tejasvaidya10/spark) *(🥉 AI for Good hackathon)* | AI-powered youth career discovery platform — personalized career pathways, mentorship matching, wellness tracking. | React, Node.js, AWS Bedrock, DynamoDB, Socket.io |
