...
**AI/ML Engineer · M.S. Data Analytics @ Georgia State University**
...
| [**NeuroScan**](https://github.com/Tejasvaidya10/NeuroScan) | Deep learning project for medical image classification. | Python, PyTorch |
...
**LLMs & GenAI** — RAG pipelines, AWS Bedrock, LLM-as-Judge evaluation, prompt engineering, embeddings
**ML & Deep Learning** — PyTorch, TensorFlow, scikit-learn, XGBoost, ensemble methods, SVMs, GAMs
**Data & Backend** — Python (pandas, NumPy), SQL (MySQL, PostgreSQL), FastAPI, R
**Infra & MLOps** — Docker, AWS, GitHub Actions (CI/CD), Oracle Cloud
**Viz** — Tableau, Power BI, matplotlib, Plotly

---

## Connect

- **LinkedIn** — [in/tejasvaidya1903](https://www.linkedin.com/in/tejasvaidya1903/)
- **Email** — vaidyatejas02@gmail.com

![Tejas's GitHub stats](https://github-readme-stats.vercel.app/api?username=Tejasvaidya10&show_icons=true&theme=default&hide_border=true&count_private=true)
